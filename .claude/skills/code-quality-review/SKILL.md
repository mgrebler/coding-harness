...
- If no result file exists → write `$SPEC_DIR/code-quality-review-result-1.json`
- If `code-quality-review-result-1.json` exists → write `code-quality-review-result-2.json`
- If `code-quality-review-result-2.json` exists → write `code-quality-review-result-3.json`
...
```
[code-quality-review] iteration 1 → PASS (8/10) → specs/015-feature/code-quality-review-result-1.json
```

or

```
[code-quality-review] iteration 1 → FAIL (5/10, 1 critical) → specs/015-feature/code-quality-review-result-1.json
```

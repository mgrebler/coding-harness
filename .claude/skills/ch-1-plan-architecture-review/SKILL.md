---
name: ch-1-plan-architecture-review
...
- If no result file exists → write `$SPEC_DIR/ch-1-plan-architecture-review-result-1.json`
- If `ch-1-plan-architecture-review-result-1.json` exists → write `ch-1-plan-architecture-review-result-2.json`
- If `ch-1-plan-architecture-review-result-2.json` exists → write `ch-1-plan-architecture-review-result-3.json`
...
```
[ch-1-plan-architecture-review] iteration 1 → PASS (9/10) → specs/015-feature/ch-1-plan-architecture-review-result-1.json
```

or

```
[ch-1-plan-architecture-review] iteration 1 → FAIL (5/10, 2 blocking) → specs/015-feature/ch-1-plan-architecture-review-result-1.json
```

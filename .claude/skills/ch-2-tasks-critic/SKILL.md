...
- If no result file exists → write `specs/$FEATURE/ch-2-tasks-critic-result-1.json`
- If `ch-2-tasks-critic-result-1.json` exists → write `ch-2-tasks-critic-result-2.json`
- If `ch-2-tasks-critic-result-2.json` exists → write `ch-2-tasks-critic-result-3.json`
...
```
[ch-2-tasks-critic] iteration 1 → FAIL (3 blocking, 1 warning) → specs/014-feature/ch-2-tasks-critic-result-1.json
```

or

```
[ch-2-tasks-critic] iteration 1 → PASS → specs/014-feature/ch-2-tasks-critic-result-1.json
```

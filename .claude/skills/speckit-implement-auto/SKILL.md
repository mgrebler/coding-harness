...
All orchestration logic lives in `.claude/agents/implement-auto.py`. This skill is a thin
...
6. On 3-iteration exhaustion: writes `specs/$FEATURE/implement-critic-escalation.md` and exits non-zero
...
- Does not implement critic or quality review logic — that lives in implement-auto.py and its subagents
